...
#define EXAMPLE_FOC_PWM_U_IN_GPIO 12
#define EXAMPLE_FOC_PWM_U_INH_GPIO 48
#define EXAMPLE_FOC_PWM_V_IN_GPIO 13
#define EXAMPLE_FOC_PWM_V_INH_GPIO 48
#define EXAMPLE_FOC_PWM_W_IN_GPIO 14
#define EXAMPLE_FOC_PWM_W_INH_GPIO 48
